...
class Board {
  ...
  public void showBoard () {
    ...
    System.out.print("\nb ");
    for (int indx = 0; indx <= 9; ++indx) {
      System.out.print(b[indx]);
      System.out.print(" ");
    }
    System.out.print("\nc ");
    for (int indx = 0; indx <= 9; ++indx) {
      System.out.print(c[indx]);
      System.out.print(" ");
    }
    System.out.print("\nd ");
    for (int indx = 0; indx <= 9; ++indx) {
      System.out.print(d[indx]);
      System.out.print(" ");
    }
    System.out.print("\ne ");
    for (int indx = 0; indx <= 9; ++indx) {
      System.out.print(e[indx]);
      System.out.print(" ");
    }
    System.out.print("\nf ");
    for (int indx = 0; indx <= 9; ++indx) {
      System.out.print(f[indx]);
      System.out.print(" ");
    }
    System.out.print("\ng ");
    for (int indx = 0; indx <= 9; ++indx) {
    ...
    System.out.print("\nh ");
    for (int indx = 0; indx <= 9; ++indx) {
      System.out.print(h[indx]);
      System.out.print(" ");
    }
    System.out.print("\ni ");
    for (int indx = 0; indx <= 9; ++indx) {
      System.out.print(i[indx]);
      System.out.print(" ");
    }
    System.out.print("\nj ");
    for (int indx = 0; indx <= 9; ++indx) {
      System.out.print(j[indx]);
      System.out.print(" ");
    }
    System.out.println("\n\n");
  }
